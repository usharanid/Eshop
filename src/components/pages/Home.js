...
import chemise1 from "../../media/images/chemise1.jpg"
import chemise2 from "../../media/images/chemise2.jpg"
import chemise3 from "../../media/images/chemise3.jpg"
import coat from "../../media/images/coat.jpg"
		...
		<>
			<div className="item">
				<div className="product-img">
					<img src={value.url} style={{ maxWidth: '100%', maxHeight: '100%' }} />
				</div>
				<div className="product-description">
					<h6><a href="" >
						{value.name}</a></h6>
						<h4> {'$' + new Intl.NumberFormat().format(value.sale_price)}</h4>
				</div>
			</div>
		</>
	)
		...
		<div>
			...
			<div className="home">
				<div className="home-inner">
								...
								<div id="myCarousel" className="carousel slide" data-ride="carousel">
									...
									<div className="carousel-inner text-center">
										<div className="carousel-item active">
											<img className="d-block w-100 img-responsive" src={require('../../media/images/banner_new.jpg')} alt={"First Slide"} />
									...
									{trending.map((value, index) => {
										return (
											<div className="swiper-slide" key={index}>
												<MobilePhone value={value} key={index} />
											</div>
										)
									})}
								</Swiper>
					...
					<div className="category">
						<div className="category-tile">
							<h4>Men's Fashion <img src={require('../../media/icons/mobile.png')} /></h4>
						</div>
